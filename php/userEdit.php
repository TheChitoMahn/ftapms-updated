            ...
            <div class="main">
                ...
                <form class="partnercontent" action="../includes/userEdit.inc.php" method="POST">
                    ...
                    <input type="text" class="txtfields" name="id" value="<?=$row['id']?>" hidden>
                        ...
                        <div class="input">
                            <input type="text" class="txtfields" name="fullname" value="<?=$row['fullname']?>" required>
                        </div>
                        <div class="lbl_name">
                            <a>Company Email</a>
                        </div>
                        <div class="input">
                            <input type="text" class="txtfields" name="companyemail" value="<?=$row['companyemail']?>" required>
                        </div>
                        <div class="lbl_name">
                            <a>Department</a>
                        </div>
                        <div class="input">
                            <input type="text" class="txtfields" name="department" value="<?=$row['department']?>" required>
                        </div>
                        <div class="lbl_name">
                            <a>Password</a>
                        </div>
                        <div class="input">
                            <input type="password" class="txtfields" name="password" value="<?=$row['password']?>" required>
                        </div>
                        <div class="lbl_name">
                            <a>Confirm Password</a>
                        </div>
                        <div class="input">
                            <input type="password" class="txtfields" name="confirmpassword"  required>
                        </div>
                        <div class="buttons">
                            <button type="submit" class="ingia_btn" name="btn-update"><a href="../php/listusers.php?error=none">Exit</a></button>
