<?php
    ...
    if (isset($_POST["check-btn"])){
        $assUID = $_POST["assID"];
        if (empty($assUID)) {
            if ($_SERVER['REQUEST_URI'] === "/FTA_Partners_System/php/MOU.php") {
    ...
    <div class='main'>
        ...
        <form class='partnercontent' action='../includes/MOU.inc.php' method='POST' enctype='multipart/form-data'>
            ...
            <div class='mousection2'>
                ...
                <div class='input'>
                    <textarea class='txtfields2' name='article31' rows='20' cols='50' required></textarea>
                </div>
                <div class='lbl_name'>
                    <a>3.2 ROLE OF OTHER PARTNER</a>
                </div>
                <div class='input'>
                    <textarea class='txtfields2' name='article32' rows='20' cols='50' required></textarea>
                </div>
                <div class='lbl_name'>
                    <a>ARTICLE 4</a> <br>
